...
//    }
    ...
    public String generateToken(Long userId) {
        ...
        try {
            String u = base64EncoderUtils.encode(String.valueOf(userId).getBytes(StandardCharsets.UTF_8));
