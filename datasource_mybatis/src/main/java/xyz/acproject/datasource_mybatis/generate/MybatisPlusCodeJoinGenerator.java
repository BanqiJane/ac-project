...
public class MybatisPlusCodeJoinGenerator {

    private static final String URL = "jdbc:mysql://localhost:3306/cx_exam?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
    // 数据库用户名
    ...
    private static final String parentPackageName = "xyz.acproject.cx_exam";
...
//                                .xml("mapper.xml")
                ...
                .strategyConfig((scanner, builder) -> builder.addInclude()
                        ...
                        .superServiceClass(BaseJoinService.class)
                        .superServiceImplClass(BaseJoinServiceImpl.class)
