...
public final class JodaTimeUtils {
	 ...
	 * @return yyyy-MM-dd HH:mm:ss
	 */
	public static String getPointDateTimeStr(Integer year, Integer month, Integer day, Integer hour, Integer minute, Integer seconds) {
	...
	public static Date getPointDateTime(Date date,Integer hour,Integer minute,Integer seconds) {
		DateTime dt = new DateTime(getYear(date), getMonth(date), getDay(date), hour, minute, seconds);
		return dt.toDate();
	}

	public static Date getPointDateTime(Integer year, Integer month, Integer day, Integer hour, Integer minute, Integer seconds) {
		DateTime dt = new DateTime(year, month, day, hour, minute, seconds);
		return dt.toDate();
	}
	...
	public static Integer formatToInt(Date date, String pattern) {
		if (date == null)date = new Date();
		if(StringUtils.isBlank(pattern))pattern="yyyyMMdd";
		DateTime dateTime = new DateTime(date);
	...
	public static Date dayFirstDay(Date date,Integer day){
		DateTime dt;
		if(day==null){
			day= 0;
		}
		...
		if(date==null) {
			dt = new DateTime().minusDays(day);
		}else{
			dt = new DateTime(date).minusDays(day);;
		}
		DateTime y = dt.withHourOfDay(0).withMinuteOfHour(0).withSecondOfMinute(0);
		return y.toDate();
	}

	public static Date dayLastDay(Date date,Integer day){
		DateTime dt;
		if(day==null){
			day= 0;
		}
	...
	public static Date weekFirstDay(Date date,Integer week){
		DateTime dt;
		if(week==null){
			week=0;
		}
		...
		if(date==null) {
			dt = new DateTime().minusWeeks(week);
		}else {
			dt = new DateTime(date).minusWeeks(week);
		}
	...
	public static Date weekLastDay(Date date,Integer week){
		DateTime dt;
		if(week==null){
			week=0;
		}
	...
	public static Date weekFiveWorkLastDay(Date date,Integer week){
		DateTime dt;
		if(week==null){
			week=0;
		}
		...
		if(date==null) {
			dt = new DateTime().minusDays(2).minusWeeks(week);
		}else {
			dt = new DateTime(date).minusDays(2).minusWeeks(week);
		}
		DateTime lastDay = dt.dayOfWeek().withMaximumValue()
				.withHourOfDay(23).withMinuteOfHour(59).withSecondOfMinute(59);
		return lastDay.toDate();
	...
	public static Date weekSixWorkLastDay(Date date,Integer week){
		DateTime dt;
		if(week==null){
			week=0;
		}
		...
		if(date==null) {
			dt = new DateTime().minusDays(1).minusWeeks(week);
		}else {
			dt = new DateTime(date).minusDays(1).minusWeeks(week);
		}
		DateTime lastDay = dt.dayOfWeek().withMaximumValue()
				.withHourOfDay(23).withMinuteOfHour(59).withSecondOfMinute(59);
		return lastDay.toDate();
	...
	public static Date monthFirstDay(Date date, Integer month) {
		...
		DateTime firstDay = dt1.dayOfMonth().withMinimumValue().
				withHourOfDay(0).withMinuteOfHour(0).withSecondOfMinute(0);
		return firstDay.toDate();
	}
	...
	public static Date changeWeek(Date date, int offset) {
		DateTime dt1;
		if(offset>=0) {
			if (date == null) {
			...
			if (date == null) {
				dt1 = new DateTime().minusWeeks(-1*offset);
				return dt1.toDate();
			}
			dt1 = new DateTime(date).minusWeeks(-1*offset);
		}
		return dt1.toDate();
	...
	public static List<Date> getDiffDays(Date start,Date end){
		...
		for(int i=0;i<=days;i++){
			list.add(startDateTime.plusDays(i).toDate());
		}
		return list;
	}
	...
	*/
	...
	public static LinkedList<Date> getSectionDays(Date startDate,Date endDate){
		LinkedList<Date> dates = new LinkedList<>();
		DateTime startDateTime = new DateTime(startDate);
		DateTime endDateTime = new DateTime(endDate);
		int days = Days.daysBetween(startDateTime, endDateTime).getDays();
		for(int i=0;i<=days;i++){
			dates.add(startDateTime.plusDays(i).toDate());
		}
		return dates;
	}
	public static LinkedList<Integer> getSectionDayInts(Date startDate,Date endDate){
		LinkedList<Integer> dates = new LinkedList<>();
		DateTime startDateTime = new DateTime(startDate);
		DateTime endDateTime = new DateTime(endDate);
		int days = Days.daysBetween(startDateTime, endDateTime).getDays();
		for(int i=0;i<=days;i++){
			dates.add(formatToInt(startDateTime.plusDays(i).toDate(),"yyyyMMdd"));
		}
		return dates;
	}
	...
	public static String formatSecond(PeriodFormatter periodFormatter,int second) {
